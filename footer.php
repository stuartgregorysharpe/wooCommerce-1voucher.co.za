                ...
                <div class="cart_item_top">
                    ...
                    <div class="cart_item_top_info">
                        ...
                        <button class="editcartitem">
                            <span class="update-cart-prod" data-cart_key="<?php echo $cart_item_key; ?>" data-prod_quantity="<?php echo $quantity; ?>" data-prod_id="<?php echo $product_id; ?>"><div>Edit</div><?php include (TEMPLATEPATH . '/images/vouchers/svg/icon_edit.svg'); ?></span>
...
<?php if ( isset($_GET['ninja']) && $_GET['ninja'] == 1 ) {
	...
	$testing = wc_get_order(54868);

    send_1FORYOU_voucher_email( 'philip@ninjasforhire.co.za', '2323', '123123', '12313', '3324' ,'philip');

	 echo 'done';

} ?>

<?php if(isset($_GET['sms']) && $_GET['sms'] == 1){

//    $file = get_template_directory()."/sms.csv";
...
//
//                send_1FORYOU_voucher_sms( '0645275963', '22', '2025-09-06', '22', '112' );
//            }
//
//            $counter++;
//        }
