    ...
    <div class="payment-success-fail">
        <div class="container">
            ...
            <div class="payment_info">
                <p>Email us at <a href="mailto:support@1voucher.com">support1voucher.com</a> you are having issue with the voucher.</p>
                <p>
                    ...
                    <a href="mailto:hello@1voucher.co.za">hello@1voucher.co.za</a>
                </p>
            </div>
            <a href="<?php echo get_option('home'); ?>/shop-listing/" class="button button-primary">Buy vouchers</a>
        </div>
    </div>
                ...
                <div class="delivery-options">
                    ...
                    <div class="order-items">
                        <p>Your vouchers will be delivered shortly.<br/>
                            You will also receive redemption instructions with the voucher.<br/>
                            Thank you for your support. Your products and order confirmation will be delivered shortly.<br/>
                            For assistance contact us on <a href="tel:0861693333">086 1693 333</a> or email <a href="mailto:hello@1voucher.co.za">hello@1voucher.co.za</a>
                        </p>
                        <?php
...
//                                    ?>
                            ...
                            <div class="order-info">
                                <div class="row-top">
                                    <div class="left_info">
                                        ...
                                        <span><?php echo $terms[0]->description; ?></span>
                                    </div>
                                    <div class="right_info">
                                        <strong> R
                                ...
                                <div class="row-info">
                                    <div class="info-col"> <span> Voucher Status</span>
                                        <?php if($voucher_code){
                                            echo 'Voucher Sent';
                                        } else {
                ...
                <div class="thankyou_lower for_desktop">
                    ...
                    <div class="right"><a href="<?php echo get_site_url(); ?>" class="button button-primary">Return to home</a></div>
                </div>
                <!-- end: thankyou_lower -->
            </div>
