        ...
        <div class="shop_listing">
            <div class="side_bar">
                ...
                <div class="col_links">
                    ...
                    <?php
                    $term_args = array('taxonomy' => 'product_cat', 'include' => $cur_cat->term_id, 'order' => 'ASC');
                ...
                <h4 class="mobile-cat-select">
                    ...
                    <span>
                       <?php echo get_field('product_category_icon', 'product_cat_'.$prod_cats[0]->term_id); ?></span>
                       <a><?php echo $prod_cats[0]->name; ?></a>
                         <!--  <a href="<?php //echo get_site_url(); ?>/shop-listing">Shop All</a> -->
                    
                </h4>
                <?php /* ?>
                    <div class="mobile-cat-select">
                        <li>
                            <span>
                                <?php echo get_field('product_category_icon', 'product_cat_'.$prod_cats[0]->term_id); ?>
                            </span>
                            <a  href="<?php echo get_term_link($prod_cats[0]->term_id); ?>"><?php echo $prod_cats[0]->name; ?></a>
                        </li>
                    </div>
 <?php */ ?>
                    ...
                    <span>
                        ...
                        foreach ($prod_cats as $prod_cat) { ?>
                            <li class="<?php if($prod_cat->term_id == $cur_cat->term_id){ echo 'active'; } ?>">
                            <span>
            ...
            <div class="shop_list">
                ...
                <div class="shop_list_flex">
                    ...
                    $numTerms = wp_count_terms( $args );

                    $prod_tags = get_terms( $args );
                    $active_terms = array();
                    $term_count = 0;
...
//                        }
                ...
                <div class="listing_loadmore">
                    ...
                    <?php if($term_count != $numTerms) { ?>
                        <a class="button button-primary" href="javascript:void(0);" data_cat="<?php echo $cur_cat->term_id; ?>" onclick="loadMorePosts(<?php echo $term_count; ?>, '<?php echo implode('|',$active_terms); ?>')">Load more</a>
                    <?php } ?>
                </div>
            ...
            <div class="prod-info-popup" data-popup="<?php echo $prod_tag->term_id; ?>" style="display: none">
                ...
                <div class="product-info-column">
                    ...
                    <form class="prodAddForm" method="POST" action="">
                        ...
                        $args = array('post_type' => 'product', 'order' => 'ASC', 'product_tag' => $prod_tag->slug);
